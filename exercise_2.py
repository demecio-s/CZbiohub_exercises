...
import tifffile
import numpy as np
from pymmcore_plus import CMMCorePlus, DeviceAdapter #device adapter allows me to change camera mode
...
#edits every image captured during acquisition process. Modified from on_image_captured function at: https://pymmcore-plus.github.io/pymmcore-plus/guides/events/
